 ...
 */
package ltistarter.repository.ltiproxy;
 ...
 */
@Transactional
public interface LtiProxyConfigRepository extends CrudRepository<LtiProxyConfig, Long> {
//extends PagingAndSortingRepository<LtiServiceEntity, Long> {
     ...
     * @return the LtiProxyConfig OR null if there is no entity matching the input
     */
    LtiProxyConfig findByUserIdAndContextIdAllIgnoringCase(String userId, String contextId);
}
