...
public class ErrorConfiguration{
    ...
    public EmbeddedServletContainerCustomizer containerCustomizer() {
        logger.debug("Attempting to init container");
        EmbeddedServletContainerCustomizer container = new EmbeddedServletContainerCustomizer() {
            ...
            public void customize(ConfigurableEmbeddedServletContainer container) {
                ...
                ErrorPage error405Page = new ErrorPage(HttpStatus.METHOD_NOT_ALLOWED, "/404.html"); // TODO Only need this for DEBUG do not commit
                ErrorPage error500Page = new ErrorPage(HttpStatus.INTERNAL_SERVER_ERROR, "/500.html");
     
                container.addErrorPages(error401Page, error404Page, error405Page, error500Page);
            }
        };
        System.out.println("I have initialized the container");
