...
public class OutcomesController {
	...
	@RequestMapping(value = "/api/{contextMappingId}/db/{dashboardId}/card/{cardId}/outcomes", method = RequestMethod.GET)
	public Set<LineItem> outcomes(
		...
		return outcomesProvider.getOutcomesForCourse(null, contextMapping.getContext());
	}
}
