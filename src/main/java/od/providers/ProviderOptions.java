...
public class ProviderOptions implements Serializable {
  ...
  public String toString() {
    return "ProviderOptions [contextMappingId=" + contextMappingId + ", dashboardId=" + dashboardId + ", cardId=" + cardId + ", courseId=" + courseId
        + ", userId=" + userId + ", roles=" + roles + ", strategy=" + strategy + ", strategyKey=" + strategyKey + ", strategyHost=" + strategyHost
        + "]";
  }
