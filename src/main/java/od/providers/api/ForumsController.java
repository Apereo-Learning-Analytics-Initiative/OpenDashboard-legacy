...
public class ForumsController {
  ...
  @RequestMapping(value = "/api/tenants/{tenantId}/contexts/{contextMappingId}/forums", method = RequestMethod.GET)
  public List<ForumImpl> forums(@PathVariable("tenantId") final String tenantId,
    ...
    return forumsProvider.getForums(providerData, contextMapping.getContext());
  }
...
System.out.println(allForums);
  ...
  public List<MessageImpl> messages(@PathVariable("tenantId") final String tenantId,
    ...
    return forumsProvider.getMessages(providerData, id);
  }
