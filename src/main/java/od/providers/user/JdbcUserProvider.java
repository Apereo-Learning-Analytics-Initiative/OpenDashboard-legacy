...
public class JdbcUserProvider extends JdbcProvider implements UserProvider {
  ...
  @Override
  public String notifyUser(ProviderData ProviderData, MuseNotify notification) throws ProviderException {

	String retVal = "Failure";
	
	try {
	  JdbcClient client = new JdbcClient(ProviderData);
	  String SQL = "INSERT INTO TB_OD_NOTIFICATION(EMAILTO, EMAILFROM, CC, SUBJECT, BODY, ATTACHMENTS, TIMESTAMP, GUID)" 
			  		+ "VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
