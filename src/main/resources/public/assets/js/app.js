...
.config(function($stateProvider, $urlRouterProvider, $locationProvider) {
    ...
    $stateProvider
        ...
        // **
         .state('index.muse', {
            url: 'direct/muse',
            templateUrl: '/assets/templates/muse/museCourseList.html',
            params: {
            	courseId: { value: null, squash: true }
            },
            controller: 'museController'
        })
         .state('index.museCourse', {
            url: 'direct/museCourse/:courseId',
            templateUrl: '/assets/templates/muse/museCourse.html',
            params: {
            	courseId: { value: null, squash: true }
            },
            controller: 'museCourseController'
        })
         .state('index.museStudent', {
            url: 'direct/museStudent/:courseId/student/:studentId',
            templateUrl: '/assets/templates/muse/museStudentView.html',
            params: {
            	courseId: { value: null, squash: true }
         ...
         .state('index.help', {
            url: 'direct/help',
            templateUrl: '/assets/templates/muse/museHelp.html',
            controller: 'museController'
        })
