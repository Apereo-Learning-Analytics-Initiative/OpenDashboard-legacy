...
// MUSE Services
  ...
  .module('OpenDashboard')
    .service('museApiService', function($log, $http) {
      return {
        getCourseList: function (tenantId, userId){
            var url = '/api/tenants/'+tenantId+'/muse/'+userId;
      		  var promise = $http({
      		    method  : 'GET',
      			url		: url,
      	...
      	getCourse: function (tenantId, userId, courseId){
      		var url = '/api/tenants/'+tenantId+'/muse/'+userId+'/course/'+courseId;
    		  var promise = $http({
    		    method  : 'GET',
    			url		: url,
    			headers : { 'Content-Type': 'application/json'}
    	...
    	notifyUser: function (tenantId, inData){
    	          var url = '/api/museNotify/'+tenantId;
    	    		  var promise = $http({
    	    		    method  : 'POST',
    	    			url		: url,
        ...
        getCourseStudent: function (tenantId, userId, courseId, studentId){
          var url = '/api/tenants/'+tenantId+'/muse/'+userId+'/course/'+courseId+'/student/'+studentId;
    		  var promise = $http({
    		    method  : 'GET',
    			url		: url,
    			headers : { 'Content-Type': 'application/json'}
    	...
    	sendToApi: function (tenantId, apiUrl, apiInData){
    	  var url = '/api/museAPI/'+tenantId+'/'+apiUrl;
    		var promise = $http({
    			method   : 'POST',
    			url		 : url,
    			headers : { 'Content-Type': 'application/json;charset=UTF-8'},
