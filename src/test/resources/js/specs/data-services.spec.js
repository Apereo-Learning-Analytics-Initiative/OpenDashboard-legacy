describe('the data-services test', function () {
    ...
    describe('the ProviderService tests', function () {
        ...
        describe('ProviderService.getProvider', function () {
            it('should not be equal to the ProviderService when key does not match in response', function () {
                httpBackend.when('GET', '/api/providers/ASSIGNMENT/LABEL_ASSIGNMENT_PROVIDERS_KEY').respond({'type': 'ASSIGNMENT',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY_FAIL', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});

                service.getProvider("ASSIGNMENT", "LABEL_ASSIGNMENT_PROVIDERS_KEY")
                        .then(function (response) {
                            expect(response).not.toEqual(jasmine.objectContaining(prov1));
                        },
                                function (error) {
            ...
            it('should not be equal to the ProviderService when type does not match in response', function () {
                httpBackend.when('GET', '/api/providers/ASSIGNMENT/LABEL_ASSIGNMENT_PROVIDERS_KEY').respond({'type': 'ASSIGNMENTS',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
            ...
            it('should be equal to the ProviderService when everything does match in response', function () {
                httpBackend.when('GET', '/api/providers/ASSIGNMENT/LABEL_ASSIGNMENT_PROVIDERS_KEY').respond({'type': 'ASSIGNMENT', 'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY',
                    'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
        ...
        describe('ProviderService.getProviderDataByKey', function () {
            it('should not be equal to the ProviderService when key does not match in response', function () {
                httpBackend.when('GET', '/api/providerdata/ASSIGNMENT/LABEL_ASSIGNMENT_PROVIDERS_KEY').respond({'type': 'ASSIGNMENT',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY_FAIL', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});

                service.getProviderDataByKey("ASSIGNMENT", "LABEL_ASSIGNMENT_PROVIDERS_KEY")
                        .then(function (response) {
                            expect(response).not.toEqual(jasmine.objectContaining(prov1));
                        },
                                function (error) {
            ...
            it('should not be equal to the ProviderService when type does not match in response', function () {
                httpBackend.when('GET', '/api/providerdata/ASSIGNMENT/LABEL_ASSIGNMENT_PROVIDERS_KEY').respond({'type': 'ASSIGNMENTS',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
            ...
            it('should be equal to the ProviderService when everything does match in response', function () {
                httpBackend.when('GET', '/api/providerdata/ASSIGNMENT/LABEL_ASSIGNMENT_PROVIDERS_KEY').respond({'type': 'ASSIGNMENT', 'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY',
                    'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
        ...
        describe('ProviderService.getProviderDataByType', function () {
            it('should not be equal to the ProviderService when key does not match in response', function () {
                httpBackend.when('GET', '/api/providerdata/ASSIGNMENT').respond({'type': 'ASSIGNMENT',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY_FAIL', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});

                service.getProviderDataByType("ASSIGNMENT")
                        .then(function (response) {
                            expect(response).not.toEqual(jasmine.objectContaining(prov1));
                        },
                                function (error) {
            ...
            it('should not be equal to the ProviderService when type does not match in response', function () {
                httpBackend.when('GET', '/api/providerdata/ASSIGNMENT').respond({'type': 'ASSIGNMENTS',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
            ...
            it('should be equal to the ProviderService when everything does match in response', function () {
                httpBackend.when('GET', '/api/providerdata/ASSIGNMENT').respond({'type': 'ASSIGNMENT', 'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY',
                    'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
        ...
        describe('ProviderService.create', function () {
            it('should not be equal to the ProviderService when key does not match in response', function () {
                httpBackend.when('POST', '/api/providerdata').respond({'type': 'ASSIGNMENT',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY_FAIL', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});

                service.create(prov1)
                        .then(function (response) {
                            expect(response).not.toEqual(jasmine.objectContaining(prov1));
                        },
                                function (error) {
            ...
            it('should not be equal to the ProviderService when type does not match in response', function () {
                httpBackend.when('POST', '/api/providerdata').respond({'type': 'ASSIGNMENTS',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
            ...
            it('should be equal to the ProviderService when everything does match in response', function () {
                httpBackend.when('POST', '/api/providerdata').respond({'type': 'ASSIGNMENT', 'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY',
                    'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
        ...
        describe('ProviderService.update', function () {
            it('should not be equal to the ProviderService when key does not match in response', function () {
                httpBackend.when('PUT', '/api/providerdata/' + prov1.type + '/' + prov1.key).respond({'type': 'ASSIGNMENT',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY_FAIL', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
            ...
            it('should not be equal to the ProviderService when type does not match in response', function () {
                httpBackend.when('PUT', '/api/providerdata/' + prov1.type + '/' + prov1.key).respond({'type': 'ASSIGNMENTS',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
            ...
            it('should be equal to the ProviderService when everything does match in response', function () {
                httpBackend.when('PUT', '/api/providerdata/' + prov1.type + '/' + prov1.key).respond({'type': 'ASSIGNMENT', 'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY',
                    'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
        ...
        describe('ProviderService.remove', function () {
            it('should not be equal to the ProviderService when key does not match in response', function () {
                httpBackend.when('DELETE', '/api/providerdata/' + prov1.type + '/' + prov1.key).respond({'type': 'ASSIGNMENT',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY_FAIL', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});

                service.remove(prov1)
                        .then(function (response) {
                            expect(response).not.toEqual(jasmine.objectContaining(prov1));
                        },
                                function (error) {
            ...
            it('should not be equal to the ProviderService when type does not match in response', function () {
                httpBackend.when('DELETE', '/api/providerdata/' + prov1.type + '/' + prov1.key).respond({'type': 'ASSIGNMENTS',
                    'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY', 'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
            ...
            it('should be equal to the ProviderService when everything does match in response', function () {
                httpBackend.when('DELETE', '/api/providerdata/' + prov1.type + '/' + prov1.key).respond({'type': 'ASSIGNMENT', 'key': 'LABEL_ASSIGNMENT_PROVIDERS_KEY',
                    'desc': 'LABEL_ASSIGNMENT_PROVIDERS_DESC'});
